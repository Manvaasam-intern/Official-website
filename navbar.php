  ...
  nav ul li {
    ...
    /*navbar style end*/
      ...
      <ul class="menu">
        ...
        <li><a target="_blank" href="https://manvaasam.com/courses.php">COURSES</a></li>
        ...
        <li>
          ...
          <ul>
            <li><a href="https://manvaasam.com/Admin_Login/admin.php" target="_blank">ADMIN</a></li>
            <li><a href="https://employee.manvaasam.com" target="_blank">MANVAASAM</a></li>
            <li><a href="https://manvaasam.com/student/login.php" target="_blank">STUDENT LMS</a></li>
          </ul>
